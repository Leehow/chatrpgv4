...
export const CARD_TEXT = ['Character draft','Character draft — reply to confirm or describe changes.','Click "Confirm and open the table", or say below what to change.',
  'Pinned','Pinned by you','Pinned by the host','Points left','Auto-spread','Non-standard card','Occupation skills','Interest skills','Other skills','Characteristic points','Occupation','Interest','Other','Eight occupation skills at most.','Age','Age changes EDU, APP, movement and Luck.','Base','Final','Custom','Custom skills','Skill name','Add','Remove','A language you speak is written as Language (Other: name).','Confirm and open the table','Reroll','Reroll the dice? Pinned numbers stay.','Yes, reroll','Earlier draft','Overspent by','Relaxed to','Above the starting cap','occupation points','interest points',
