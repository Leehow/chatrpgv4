...
export const COC_TOOLS: readonly CocToolSpec[] = [
	...
	},
	{
		...
		parameters: Type.Object({
			effects: Type.Array(
				Type.Union([EndingEffect, MoveEffect, ClueEffect, TimeEffect, DamageEffect, ItemEffect, DefineEffect, ObjectEffect, AbilityEffect, CashEffect, FlagEffect, NoteEffect, RulingEffect, NpcEffect, ThreatEffect, ForkEffect, SwitchEffect, MergeEffect, HandoutEffect, MapEffect]),
