...
export function resolveImagesRoot() {
    ...
    if (!agentDir) {
        throw new Error("PI_COC_AGENT_DIR / PI_CODING_AGENT_DIR not detected — cannot determine the image isolation directory (refusing to fall back to the global ~/.pi/agent)");
    }
