...
export class NoAgentHomeError extends Error {
    constructor() {
        super("PI_COC_AGENT_DIR / PI_CODING_AGENT_DIR not detected — refusing to fall back to the global ~/.pi/agent (project isolation). Set one of them in the host environment and try again.");
