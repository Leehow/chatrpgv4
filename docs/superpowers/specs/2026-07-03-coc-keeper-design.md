...
The completion audit must also reject battle reports whose Investigator Creation omits structured reusable-investigator `creation.json` values for generated characteristics, characteristic half/fifth values, age choice, age modifier bracket, EDU improvement checks, characteristic reductions, APP reduction, MOV penalty, occupation skill points, personal-interest skill points, credit rating, skill allocation, and equipment, allowing machine glossary localization for player-visible names, occupations, skills, and gear.

The completion audit must also reject battle reports whose Character Dossier omits structured reusable-investigator `character.json` values for name/id, occupation, era, characteristics, characteristic half/fifth values, derived values, skills, and backstory, allowing language-profile labels and glossary localization for player-visible names, occupations, skills, and character-sheet terms.
