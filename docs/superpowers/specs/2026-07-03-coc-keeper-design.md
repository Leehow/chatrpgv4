...
The completion audit must also reject battle reports whose Investigator Creation omits structured reusable-investigator `creation.json` values for generated characteristics, age choice, age modifier bracket, EDU improvement checks, characteristic reductions, APP reduction, MOV penalty, occupation skill points, personal-interest skill points, credit rating, skill allocation, and equipment, allowing machine glossary localization for player-visible names, occupations, skills, and gear.
