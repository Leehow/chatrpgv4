...
- **Dual-Track Law（AGENTS.md）**：运行时 + 数据 + 文档改动先动 `plugins/coc-keeper/`，再 `python3 scripts/sync_coc_plugin_copy.py` + `--check`。story-graph-schema.md / compile-protocol.md / SKILL.md 若在 drift allowlist 则 sync 做替换，否则逐字节同步。
...
- **测试门禁**：改 shared 行为后至少跑：
  ```
  PYTHONDONTWRITEBYTECODE=1 python3 -m pytest tests/test_plugin_metadata.py tests/test_zcode_plugin_metadata.py tests/test_coc_plugin_sync_script.py tests/test_scenario_compile.py tests/test_storylets.py -q -p no:cacheprovider
...
python3 scripts/sync_coc_plugin_copy.py --check
git add plugins/coc-keeper/scripts/coc_storylets.py plugins/coc-keeper-zcode/scripts/coc_storylets.py tests/test_storylets.py
...
python3 scripts/sync_coc_plugin_copy.py
python3 scripts/sync_coc_plugin_copy.py --check
diff plugins/coc-keeper/skills/coc-scenario-import/references/story-graph-schema.md plugins/coc-keeper-zcode/skills/coc-scenario-import/references/story-graph-schema.md && echo identical
```

- [ ] **Step 4: commit**

```bash
git add plugins/coc-keeper/skills/coc-scenario-import/references/story-graph-schema.md plugins/coc-keeper-zcode/skills/coc-scenario-import/references/story-graph-schema.md
...
python3 scripts/sync_coc_plugin_copy.py
python3 scripts/sync_coc_plugin_copy.py --check
git add plugins/coc-keeper/skills/coc-scenario-import/references/compile-protocol.md plugins/coc-keeper-zcode/skills/coc-scenario-import/references/compile-protocol.md
...
python3 scripts/sync_coc_plugin_copy.py
python3 scripts/sync_coc_plugin_copy.py --check
git add plugins/coc-keeper/skills/coc-scenario-import/SKILL.md plugins/coc-keeper-zcode/skills/coc-scenario-import/SKILL.md
...
```bash
git add plugins/coc-keeper/references/starter-scenarios/the-white-war/story-graph.json plugins/coc-keeper-zcode/references/starter-scenarios/the-white-war/story-graph.json
...
```bash
git add plugins/coc-keeper/references/rules-json/storylet-library.json plugins/coc-keeper-zcode/references/rules-json/storylet-library.json tests/test_storylets.py
...
- [ ] **Step 3: sync 门禁 + 双轨一致性**

Run:
```
python3 scripts/sync_coc_plugin_copy.py --check
diff plugins/coc-keeper/references/starter-scenarios/the-white-war/story-graph.json plugins/coc-keeper-zcode/references/starter-scenarios/the-white-war/story-graph.json && echo identical
diff plugins/coc-keeper/references/rules-json/storylet-library.json plugins/coc-keeper-zcode/references/rules-json/storylet-library.json && echo identical
```
