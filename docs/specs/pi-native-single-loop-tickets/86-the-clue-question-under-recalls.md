...
- Live (gate #18, grok-4.5): clue_follow_up TP 7 / FP 0 / FN 8, recall 0.47 (from 0.22), precision 1.0; five TPs at 0.42–0.51 cleared only by the per-class gate 0.4/0.67 (§135.32 addendum 3.1). Remaining FN at 0.11–0.37 (neighbor-lawsuit-1852 0.27, basement-burial-lawsuit 0.30, vittorio-bible-weapon 0.37, nailed-windows 0.20, catholic-wards 0.11, upstairs-disturbance 0.13, mythos-reek 0.16, rusted-basement-dagger 0.35): the state/criteria is the next lever, not the gate.
