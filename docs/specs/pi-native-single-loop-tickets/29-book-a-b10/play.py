...
W = '/Users/haoli/leehow/code/chatrpgv4-wt-sl29a-b10'
HOME = f'{W}/.coc/playtests/sl29a-b10/home'
...
def sentence(n):
    ...
    return T[n]
log = open(os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', '..', '..', '..', '.coc', 'playtests', 'sl29a-b10', 'turns.log'), 'a')
