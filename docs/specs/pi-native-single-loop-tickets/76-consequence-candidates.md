...
- Live (gate #16, shadow): 15/21 turns with a shadow call, Jev median 495 ms; clue_follow_up 1 cleared-but-false (t3); npc_reaction corrected 2/4; Jev outage t8–14 (SL-84) removed those turns from the sample.
