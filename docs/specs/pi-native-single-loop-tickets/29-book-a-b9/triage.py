"""Per-turn structural triage of a driver table (same columns as the long-gate triage, extended for batch 9's
SL-58/59/60/61/62/63 signals): python3 triage.py <campaign> <run>"""
import json, sys, os, glob, collections, statistics
W=os.environ.get('WT','/Users/haoli/leehow/code/chatrpgv4-wt-sl29a-b9'); CID, RUN = sys.argv[1], sys.argv[2]
