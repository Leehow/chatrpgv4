...
### 2026-09-26 — long live gate #12, regression on batch 11 (integration `e8a883604`: SL-68/69/70 on top of batch 10; deepseek-v4.1-flash Keeper, thinking off through the product's corrections; campaign `longgate12-haunting-2016`, fresh from the starter)

Pre-registration `live-gate-long12-preregistration.md`; structural table `longgate12-triage.txt`.
