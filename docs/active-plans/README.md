...
| coc-tiered-background-orchestration | [Tiered background orchestration and first-contact readiness](coc-tiered-background-orchestration.md) | `In Progress` | 2026-07-21 | Codex coordinator claim→nested leaf→fulfill is proven and experimental; run the window-equivalent three-minute opening and multi-NPC first-contact acceptance path next. Cursor remains fail-closed. |
