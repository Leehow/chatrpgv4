...
```
{"findings": [{"kind": "reveal"|"uncommitted_state"|"player_agency", "quote": "<正文里的原句，≤ 120 字>", "why": "<≤ 200 字>", "clue": "<揭示的是哪条未发现线索，只在 reveal 上，见 §47.3>"}]}
```
...
## 47. 叙述交付的线索：记得下，以及记不下时账上留痕（2026-09-16）
...
### 47.4 胶囊的 `unrecorded`：账上的缺口活过这一回合
