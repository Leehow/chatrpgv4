...
type PresentationActionProps = {onChoose?: (entry:NonNullable<ChatMessage['presentation']>,option:string)=>Promise<unknown>; onDraftOverride?: (entry:NonNullable<ChatMessage['presentation']>,request:Record<string,unknown>)=>Promise<Record<string,any>>; onDraftConfirm?: DraftAction; onDraftSpread?: DraftAction; onDraftReroll?: DraftAction}
...
export function Transcript({ stateKey, messages: rawMessages, transcriptRef, waiting, active = true, onLoadOlder, documentBasePath, onOpenDocument, onOpenSubagents, onChoose, onDraftOverride, onDraftConfirm, onDraftSpread, onDraftReroll, onCopy, onResend, resendDisabled, copiedId, onBranch, branchMessageIds, branchDisabled, onIllustrate, illustrateDisabled, illustrations, actionWords, navigation }: {
...
export const MessageView = memo(function MessageView({ message, showFooter, draftSuperseded, documentBasePath, onOpenDocument, onOpenSubagents, onChoose, onDraftOverride, onDraftConfirm, onDraftSpread, onDraftReroll, onCopy, onResend, resendDisabled, copied, onBranch, branchMessageIds, branchDisabled, onIllustrate, illustrateDisabled, illustration, actionWords, canJump = false, onJump }: { message: ChatMessage; showFooter?: boolean; draftSuperseded?: boolean; copied?: boolean; canJump?: boolean; onJump?: () => void; illustration?: IllustrationState } & DocumentOpenProps & SubagentOpenProps & PresentationActionProps & Omit<MessageActionHandlers, 'copiedId' | 'illustrations'>) {
  ...
  if (message.presentation) return <><PresentationEntry message={message} illustration={illustrationNode} draftSuperseded={draftSuperseded} onChoose={onChoose} onDraftOverride={onDraftOverride} onDraftConfirm={onDraftConfirm} onDraftSpread={onDraftSpread} onDraftReroll={onDraftReroll} />{marked && <div className="message presentation-footer">{footer}</div>}</>
