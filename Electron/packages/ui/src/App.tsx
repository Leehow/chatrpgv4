...
function AppContent({ host: injectedHost }: { host?: PipiHostAPI }) {
  ...
  const productToolsCollapsed = toolsCollapsed || productPanels.length === 0 || onboardingActive
