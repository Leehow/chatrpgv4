...
/**
 * The delivery card's trailing mechanics slip folds, in the real React the transcript mounts it with.
 *
 * The owner at the live table (2026-09-22): the slip under the prose may fold away. It starts folded;
 * a row the Keeper placed at its sentence is not part of it; the folded caption still counts the rows
 * and carries the §129 waiting mark while one of them is preparing its details; and a host redraw of
 * the same card (the details landing) keeps the slip the way the player left it. Structure only.
 */
