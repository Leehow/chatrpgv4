...
const OPENAI_EXTENSION = pathToFileURL(
  join(dirname(fileURLToPath(import.meta.url)), "../../../packs/hosted-provider-tools/agent/pipiui-openai-server-tools.ts"),
).href;
const CODEX_EXTENSION = pathToFileURL(
  join(dirname(fileURLToPath(import.meta.url)), "../../../packs/hosted-provider-tools/agent/pipiui-codex-server-tools.ts"),
).href;
