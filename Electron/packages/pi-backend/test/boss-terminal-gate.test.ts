...
import { assessTerminalSend } from "../../../packs/terminal-extension/agent/pipiui-electron-terminal.ts";
 ...
 */
const TERMINAL_EXTENSION = new URL("../../../packs/terminal-extension/agent/pipiui-electron-terminal.ts", import.meta.url).href;
