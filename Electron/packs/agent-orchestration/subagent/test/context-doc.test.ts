...
const SHARED = [
	...
	"Do not touch Electron/packs/agent-orchestration/subagent/index.ts in this wave; it is owned by another slice.",
...
test("a small overlap inside two large briefs stays below the ratio bar", () => {
	const oneSharedLine = "Do not touch Electron/packs/agent-orchestration/subagent/index.ts in this wave; it is owned by another slice."
