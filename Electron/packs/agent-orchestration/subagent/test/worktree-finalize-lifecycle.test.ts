...
import { evaluateAutoMergeReadinessV1 } from "../../../git-capability/host/worktree/policy.ts";
import { NodeGitWorktreeAdapter } from "../../../git-capability/host/worktree/adapter.ts";
import { WorktreeFinalizationServiceV1 } from "../../../git-capability/host/worktree/service.ts";
import { sweepLeftoverWorktreesV1 } from "../../../git-capability/host/worktree/sweep.ts";
...
// The finalizer consumes the registered git-capability provider at operation time.
