...
Rules:
- Do NOT modify files.
- Bash is read-only: `git diff`, `git log`, `git show`. No builds that mutate the tree, and it is not where you search — use the read and retrieval tools, whose results the runtime can render and attribute.
