...
def test_a_discovered_clue_leaves_the_thread_and_the_capsule_carries_it(kernel):
    ...
    assert craft["settings"] == {"coarse_language": True, "density_guide": "off", "reference_mode": "jev"}, "narration-craft 1.7.1: default-on reference, optional density guide, coarse language"
