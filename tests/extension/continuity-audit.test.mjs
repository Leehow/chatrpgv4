...
/** §NN: it is never an accepted report either -- it is a delivery nobody judged, and it says so. */
...
/**
 * §38.8: the row is still written, and it still says which condition fired. §NN changed what the
