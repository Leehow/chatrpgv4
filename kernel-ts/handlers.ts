...
export const KNOWN_METHODS = Object.freeze([
  ...
  "mods.install", "mods.defaults", "mods.context", "mods.craft.read", "mods.job", "mods.identity.plan", "mods.accept", "mods.prefetch.accept", "mods.prefetch.targets", "mods.queued", "mods.review.status",
