...
export const KNOWN_METHODS = Object.freeze([
  ...
  "journal.job", "journal.submit", "journal.fail",
  ...
  "mods.install", "mods.defaults", "mods.context", "mods.job", "mods.accept", "mods.prefetch.accept", "mods.queued", "mods.review.status",
