...
export class Reading {
    ...
    async request(params: Row): Promise<Row> {
        ...
        return this.mutex(mid, async () => {
            ...
            if (purpose === 'guidance') {
                if (typeof guidanceKey !== 'string' || guidanceKey.length !== 64 || !/^[a-f0-9]{64}$/.test(guidanceKey) || !['zh-Hans', 'en'].includes(params.play_language) || !Array.isArray(params.occupations))
