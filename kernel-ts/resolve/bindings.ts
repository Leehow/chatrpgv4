...
export function executorArgs(context: SettleContext, plan: Row, selected: Row): Row {
    ...
    if (capability === 'check') {
        ...
        // were filtered out of the plan and the roll came out plain (§NN). The pushed roll keeps the
        ...
        // favour. The opponent rolls plain unless the rules give them something of their own (§NN).
