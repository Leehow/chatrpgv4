...
export function sessionExtensionPaths(entrypoints: RuntimeEntrypoints): readonly string[];
export function desktopSessionExtensionPaths(entrypoints: RuntimeEntrypoints): readonly string[];
export function readerProviderExtensionPaths(entrypoints: RuntimeEntrypoints): readonly string[];
export function extensionArgs(paths: readonly string[]): string[];
