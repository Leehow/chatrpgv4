...
def _quality_dimension_contracts() -> list[dict[str, str]]:
    questions = {
        ...
        "chinese_visible_dialogue": "Are the visible Keeper and virtual player dialogue turns written in Chinese for zh-Hans runs, using localized_terms for names, setting terms, player-visible skill display names, and visible Mechanical Log summaries while machine-readable markers, JSON keys, canonical skill keys, hidden Mechanical Log audit anchors, and enum values remain stable?",
