...
def _quality_dimension_contracts() -> list[dict[str, str]]:
    questions = {
        ...
        "virtual_player_pressure": "Does the test replay one single simulated player through clearly distinct play-style profiles to pressure-test Keeper rulings, pacing, and rule explanations within the single-player current scope?",
