...
Flag spoiler leaks, state errors, unlogged rolls, poor pacing, incorrect rules, `investigator_chronicle_missing`, `investigator_chronicle_not_rendered`, `temporary_insanity_bout_missing`, `temporary_insanity_bout_duration_missing`, `temporary_insanity_bout_not_rendered`, `chase_tracker_not_rendered`, `report_shell_not_localized`, `transcript_labels_not_localized`, `transcript_detail_values_not_localized`, `character_dossier_labels_not_localized`, `character_dossier_terms_not_localized`, `report_actor_ids_not_localized`, `report_state_ids_not_localized`, `report_event_type_labels_not_localized`, `report_actor_label_repeated`, `localized_empty_placeholders_not_rendered`, and `player_profile_labels_not_localized`.
