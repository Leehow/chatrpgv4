...
- `sandbox/.coc/campaigns/<campaign-id>/scenario/handouts.json`: structured player-visible handout labels, titles, summaries, and optional routes. Reports render these through `localized_text[play_language]` and `localized_terms[play_language]`; stable handout ids stay in JSON.
